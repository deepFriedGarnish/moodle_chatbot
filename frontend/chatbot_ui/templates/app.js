            ...
            if (item.name === "Bot"){
                item.message.reverse().forEach(msg => {
                    if (msg.indexOf('csharp') !== -1){
                        html += '<div class="messages__item messages__item--visitor pre"><pre>' + msg + '</pre></div>';
                    } else {
...
function loadChatbotUI() {
    ...
    chatbox__header__imageImg.src = "https://cdn.jsdelivr.net/gh/deepFriedGarnish/moodle_chatbot@1.0.5/frontend/chatbot_ui/static/images/moodle-logo.svg"
    ...
    chatbox__helpBtn__img.src = "https://cdn.jsdelivr.net/gh/deepFriedGarnish/moodle_chatbot@1.0.5/frontend/chatbot_ui/static/images/help-button.svg";
    ...
    chatbox__faqBtn__img.src = "https://cdn.jsdelivr.net/gh/deepFriedGarnish/moodle_chatbot@1.0.5/frontend/chatbot_ui/static/images/faq-icon.svg";
    ...
    chatbox__footerImg.src = "https://cdn.jsdelivr.net/gh/deepFriedGarnish/moodle_chatbot@1.0.5/frontend/chatbot_ui/static/images/send-button.svg";
    ...
    chatbox__buttonImg.src = "https://cdn.jsdelivr.net/gh/deepFriedGarnish/moodle_chatbot@1.0.5/frontend/chatbot_ui/static/images/chatbox-icon.svg";

    const cssSheet = document.createElement("link");
    cssSheet.rel = "stylesheet";
    cssSheet.type = "text/css";
    cssSheet.href = "https://cdn.jsdelivr.net/gh/deepFriedGarnish/moodle_chatbot@1.0.5/frontend/chatbot_ui/static/css/main.css";
